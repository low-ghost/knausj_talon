...
# air break cap drum each fine gust harp sit jort catra lunar made nil odd put quench red sun trap tune vest navi plex yarn zuko
# air bat cap drum each fine gust harp sit jort catra lunar made nil odd put quench red sun trap tune vest navi plex yarn zuko

default_alphabet = "air bat cap dell each fine gust harp sit jort koop lug made near oak pit quench red sun trap urge vest whale plex yank zuko".split(
    " "
)
...
ctx.lists["self.modifier"] = {
    "command": "cmd",
    # other slang: pretzel, apple, drone
    "pretzel": "cmd",
    "control": "ctrl",
    "troll": "ctrl",
...
simple_keys = ["escape", "enter", "space", "pageup", "pagedown", "end"]
alternate_keys = {
    "delete": "backspace",
    "junk": "backspace",
